...
import "github.com/yoas0bi/micro-toolkit/pb/page/page.proto";
import "github.com/yoas0bi/micro-toolkit/pb/request/request.proto";
...
message QueryBookRequest {
    // 分页参数
    // @gotags: json:"page" 
    yoas0bi.micro_toolkit.page.PageRequest page = 1;
    // 关键字参数
...
message UpdateBookRequest {
    ...
    yoas0bi.micro_toolkit.request.UpdateMode update_mode = 2;
    // 更新人
