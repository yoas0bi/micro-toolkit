...
MCUBE_MODULE := "github.com/yoas0bi/micro-toolkit"
...
pb: ## Copy mcube protobuf files to common/pb
	@mkdir -pv common/pb/github.com/yoas0bi/micro-toolkit/pb
	@cp -r ${MCUBE_PKG_PATH}/pb/* common/pb/github.com/yoas0bi/micro-toolkit/pb
	@rm -rf common/pb/github.com/yoas0bi/micro-toolkit/pb/*/*.go
