...
func (td *helper.TsDebug) GetFuncName(f interface{}, onlyFun ...bool) (funcName string) {
...
func (td *helper.TsDebug) GetFuncLine() (line int) {
	// Skip this function, and fetch the PC and file for its parent
...
func (td *helper.TsDebug) GetFuncFile() (file string) {
	_, file, _, _ = runtime.Caller(1)
	return
}

// GetFuncDir 获取调用方法的文件目录
func (td *helper.TsDebug) GetFuncDir() string {
	return filepath.Dir(td.GetFuncFile())
}

// DumpStacks 打印堆栈信息.
func (td *helper.TsDebug) DumpStacks() {
	buf := make([]byte, 16384)
...
func (td *helper.TsDebug) HasMethod(t interface{}, method string) (exist bool) {
	_, exist = reflect.TypeOf(t).MethodByName(method)
	return
}

// GetFuncPackage 获取调用方法或源文件的包名.funcFile为源文件路径.
func (td *helper.TsDebug) GetFuncPackage(funcFile ...string) string {
...
func (td *helper.TsDebug) GetMethod(f interface{}, method string) interface{} {
...
// 若执行成功,则结果是该方法的返回结果;
// 否则返回(nil, error)
func (td *helper.TsDebug) CallMethod(f interface{}, method string, args ...interface{}) ([]interface{}, error) {
	m := td.GetMethod(f, method)
	if m == nil {
...
// CallFunc 动态调用函数.
func (td *helper.TsDebug) CallFunc(f interface{}, args ...interface{}) (results []interface{}, err error) {
...
// getMethod 获取对象的方法.
func (td *helper.TsDebug) getMethod(f interface{}, method string) reflect.Value {
...
// 返回有效的函数、有效的参数.
func (td *helper.TsDebug) ValidFunc(f interface{}, args ...interface{}) (vf reflect.Value, vars []reflect.Value, err error) {
