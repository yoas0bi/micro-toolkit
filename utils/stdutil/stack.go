...
// returns:
//
//	github.com/yoas0bi/micro-toolkit/utils/stdutil_test.someFunc2(),stack_test.go:26
...
func GetCallersInfo(skip, max int) []string {
	...
	for i := skip; i < max; i++ {
		...
		if strings.ContainsRune(file, '/') {
			name = fc.Name()
			file = path.Base(file)
			// eg: github.com/yoas0bi/micro-toolkit/utils/stdutil_test.someFunc2(),stack_test.go:26
