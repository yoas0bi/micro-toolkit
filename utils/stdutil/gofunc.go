...
type FullFcName struct {
	// FullName eg: github.com/yoas0bi/micro-toolkit/utils/stdutil.PanicIf
	FullName string
	pkgPath  string
	pkgName  string
	funcName string
...
// PkgPath string get. eg: github.com/yoas0bi/micro-toolkit/utils/stdutil
...
// eg:
//
//	// OUTPUT: github.com/yoas0bi/micro-toolkit/utils/stdutil.PanicIf
