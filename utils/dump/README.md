...
- Github: https://github.com/yoas0bi/micro-toolkit/utils/dump
- GoDoc: https://pkg.go.dev/github.com/yoas0bi/micro-toolkit/utils/dump

## Install

```bash
go get github.com/yoas0bi/micro-toolkit/utils/dump
```

## Go docs

- [Go docs](https://pkg.go.dev/github.com/yoas0bi/micro-toolkit/utils/dump)
