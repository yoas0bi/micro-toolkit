...
func TestEqualFloat(t *testing.T) {
	...
	chk1 := helper.TFloat.EqualFloat(f1, f2)
	chk2 := helper.TFloat.EqualFloat(f1, f2, 6)
...
func TestRound(t *testing.T) {
	got := float64(3)
	want1 := helper.TFloat.Round(3.14)
	if got != want1 {
		t.Errorf("Round unit test, The values of %v is not %v\n", want1, got)
	}

	want2 := helper.TFloat.Round(3.55)
	if got != want2 {
		t.Errorf("Round unit test, The values of %v is not %v\n", want2, got)
	}
}
...
func TestCeil(t *testing.T) {
	num1 := 0.3
	num2 := 1.6
	res1 := helper.TFloat.Ceil(num1)
	res2 := helper.TFloat.Ceil(num2)
...
func TestFloor(t *testing.T) {
	num1 := 0.3
	num2 := 0.6
	res1 := helper.TFloat.Floor(num1)
	res2 := helper.TFloat.Floor(num2)
...
func TestMaxFloat64(t *testing.T) {
	...
	res := helper.TFloat.MaxFloat64(nums...)
	if int(res) != 9 {
		t.Error("MaxFloat64 unit test fail")
		return
	}

	res = helper.TFloat.MaxFloat64(-1)
	if int(res) != -1 {
		t.Error("MaxFloat64 unit test fail")
		return
	}
...
func TestMaxMinFloat64(t *testing.T) {
	nums := []float64{-4, 0, 3, 9}
	res := helper.TFloat.MinFloat64(nums...)
	if int(res) != -4 {
		t.Error("MinFloat64 unit test fail")
		return
	}

	res = helper.TFloat.MinFloat64(-1)
	if int(res) != -1 {
		t.Error("MinFloat64 unit test fail")
		return
	}
...
func TestIsNegative(t *testing.T) {
	for _, test := range helper.exampleFloatIsNegative {
		actual := helper.TValidate.IsNegative(test.param)
...
func TestIsPositive(t *testing.T) {
	for _, test := range helper.exampleFloatIsPositive {
		actual := helper.TValidate.IsPositive(test.param)
		if actual != test.expected {
...
func TestIsNonNegative(t *testing.T) {
	for _, test := range helper.exampleFloatIsNonNegative {
		actual := helper.TValidate.IsNonNegative(test.param)
		if actual != test.expected {
...
func TestIsNonPositive(t *testing.T) {
	for _, test := range helper.exampleFloatIsNonPositive {
		actual := helper.TValidate.IsNonPositive(test.param)
		if actual != test.expected {
...
func TestIsWhole(t *testing.T) {
	for _, test := range helper.exampleFloatIsWhole {
		actual := helper.TValidate.IsWhole(test.param)
		if actual != test.expected {
...
func TestInRangeFloat32(t *testing.T) {
	for _, test := range helper.exampleFloatTests {
		actual := helper.TValidate.IsRangeFloat32(test.param, test.left, test.right)
		if actual != test.expected {
...
func TestInRangeFloat64(t *testing.T) {
	for _, test := range helper.exampleFloatTests {
		actual := helper.TValidate.IsRangeFloat64(float64(test.param), float64(test.left), float64(test.right))
		if actual != test.expected {
...
func TestAverageFloat64(t *testing.T) {
	...
	res1 = helper.TValidate.AverageFloat64()
	res2 = helper.TValidate.AverageFloat64(1)
	res3 = helper.TValidate.AverageFloat64(1, 2, 3, 4, 5, 6)
...
func TestSumFloat64(t *testing.T) {
	sum := helper.TFloat.SumFloat64(0.0, 1.1, -2.2, 3.30, 5.55)
	if helper.TInt.NumberFormat(sum, 2, ".", "") != "7.75" {
