...
func (s *stack) WriteTo(w io.Writer) (int64, error) {
	...
	for _, pc := range *s {
		...
		// f.Name() eg: github.com/yoas0bi/micro-toolkit/utils/errorx_test.TestWithPrev()
...
// Returns eg:
//
//	github.com/yoas0bi/micro-toolkit/utils/errorx_test.TestWithPrev(), errorx_test.go:34
...
// Returns eg:
//
//	github.com/yoas0bi/micro-toolkit/utils/errorx_test.TestWithPrev()
//	  At /path/to/github.com/yoas0bi/micro-toolkit/utils/errorx_test.go:34
